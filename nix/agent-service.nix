  ...
  service = pkgs.writeTextFile {
    ...
    text = generateService "grow-agent" {
      ...
      environment = {
        ...
        # sample
        GROW_AGENT_AIR_SAMPLE_LEFT_SENSOR_ADDRESS = "0x77";
        GROW_AGENT_AIR_SAMPLE_RIGHT_SENSOR_ADDRESS = "0x76";
        GROW_AGENT_AIR_SAMPLE_RATE_SECS = "1800";

        GROW_AGENT_LIGHT_SAMPLE_LEFT_SENSOR_ADDRESS = "0x23";
        GROW_AGENT_LIGHT_SAMPLE_RIGHT_SENSOR_ADDRESS = "0x5C";
        GROW_AGENT_LIGHT_SAMPLE_RATE_SECS = "1800";
